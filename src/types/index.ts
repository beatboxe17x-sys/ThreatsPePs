...
export const DEFAULT_PRODUCTS: Record<string, Product> = {
  bpc157: {
    ...
    coa: '/images/coa-bpc157.png?v=5',
  },
  ghkcu: {
    name: 'GHK-Cu',
    price: 44.99,
    img: '/images/ghk-cu.png?v=5',
    mg: '100 MG',
    ...
    highlights: ['Copper peptide complex', '100 MG research-grade', '99%+ purity verified', 'COA included'],
  },
  sermorelin: {
    name: 'Sermorelin',
    price: 59.99,
    img: '/images/sermorelin.png?v=5',
    mg: '10 MG',
    ...
    coa: '/images/coa-sermorelin.png?v=5',
  },
  semax: {
    name: 'Semax',
    price: 64.99,
    img: '/images/semax.png?v=5',
    mg: '10 MG',
    ...
    coa: '/images/coa-semax.png?v=5',
  },
  selank: {
    name: 'Selank',
    price: 64.99,
    img: '/images/selank.png?v=5',
    mg: '10 MG',
    shopify: 'https://nextgen-research-2.myshopify.com/products',
    ...
    coa: '/images/coa-selank.png?v=5',
  },
  tirzepatide: {
    name: 'Tirzepatide',
    price: 84.99,
    img: '/images/tirzepatide.png?v=5',
    mg: '10 MG',
    shopify: 'https://nextgen-research-2.myshopify.com/products',
  ...
  retatrutide: {
    name: 'Retatrutide',
    price: 79.99,
    img: '/images/retatrutide.png?v=5',
    mg: '20 MG',
    shopify: 'https://nextgen-research-2.myshopify.com/products/glp-3-rt-20-mg?variant=48566637789411',
    ...
    coa: '/images/coa-retatrutide.png?v=5',
  },
  bacwater: {
    name: 'Bacteriostatic Water',
    price: 14.99,
    img: '/images/bacwater.png?v=5',
    mg: '10 mL',
