...
export const DEFAULT_PRODUCTS: Record<string, Product> = {
  retatrutide: {
    ...
    coa: '/images/coa-retatrutide.png',
  },
  sermorelin: {
    name: 'Sermorelin',
    price: 59.99,
    img: '/images/sermorelin.png',
    mg: '10 MG',
  ...
  bpc157: {
    ...
    coa: '/images/coa-bpc157.png',
  },
  bacwater: {
    name: 'Bacteriostatic Water',
    price: 14.99,
    img: '/images/bacwater.png',
    mg: '10 mL',
