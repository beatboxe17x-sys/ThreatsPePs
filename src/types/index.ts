...
export const DEFAULT_PRODUCTS: Record<string, Product> = {
  retatrutide: {
    name: 'Retatrutide',
    price: 79.99,
    img: '/images/retatrutide.png?v=2',
    mg: '20 MG',
    ...
    coa: '/images/coa-retatrutide.png?v=2',
  },
  sermorelin: {
    name: 'Sermorelin',
    price: 59.99,
    img: '/images/sermorelin.png?v=2',
    mg: '10 MG',
    ...
    coa: '/images/coa-sermorelin.png?v=2',
  },
  ghkcu: {
    name: 'GHK-Cu',
    price: 44.99,
    img: '/images/ghk-cu.png?v=2',
    mg: '100 MG',
  ...
  bpc157: {
    ...
    coa: '/images/coa-bpc157.png?v=2',
  },
  bacwater: {
    name: 'Bacteriostatic Water',
    price: 14.99,
    img: '/images/bacwater.png?v=2',
    mg: '10 mL',
  ...
  semax: {
    ...
    coa: '/images/coa-semax.png?v=2',
  },
  selank: {
    name: 'Selank',
    price: 64.99,
    img: '/images/selank.png?v=2',
    mg: '10 MG',
    shopify: 'https://nextgen-research-2.myshopify.com/products',
    ...
    coa: '/images/coa-selank.png?v=2',
  },
  tirzepatide: {
    name: 'Tirzepatide',
    price: 84.99,
    img: '/images/tirzepatide.png?v=2',
    mg: '10 MG',
    shopify: 'https://nextgen-research-2.myshopify.com/products',
